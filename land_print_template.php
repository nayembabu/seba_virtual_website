...
<div id="printArea" style="width: 815px; margin: 0 auto;">
    <div class="col-md-12">
        ...
        $chl = str_replace('https://dakhila.ldtax.gov.bdi.ink', 'https://dakhila.ldtax.gov.bdi.ink', route('user.land.verify', $data['uid']));
                      ...
                      <div style="font-family:&#39;kalpurush&#39;,Arial,sans-serif; font-size:14px !important; line-height:1.2;color: #333; background-color: #fff; width: 7.9in; border-radius: 10px; border: dotted 1px; padding: 10px; float: left; margin: 30px auto;">
                        <div class="row">
                          <div class="col-md-12">
                            <div style="">
                              <table style="width: 100%;">
                                <tbody>
                                  ...
                                  <tr>
                                    <td class="text-center" colspan="2"> ভূমি উন্নয়ন কর পরিশোধ রসিদ </td>
                                  </tr>
                                  <tr>
                             ...
                             <table style="margin-top:5px; width:100%;">
                                <tbody>
                                  <tr>
                                    <td style="width: 225px">২ নং রেজিস্টার অনুযায়ী হোল্ডিং নম্বর:</td>
                            ...
                            <table class="b1" style="border-collapse: collapse; margin:10px 2px ; width: <?php echo $twidth; ?>%; font-size: 11px; float: left;">
                              <thead>
                                <tr>
      ...
      <th class="b1" style="text-align: center;">মালিকের অংশ</th></tr>
                              ...
                              <tbody style="height: 21px;">
                                ...
                                <?php for($i = 1; $i<=$mhalf; $i++) { ?>
                                 
                                <tr>
                                  <td class="b1 input_bangla"><?php echo bn_number($i); ?></td>
                                  <td class="b1"><?php echo $mdatas[$i-1]->name; ?></td>
                                  <td class="b1 input_bangla" style="text-align: center;"><?php echo $mdatas[$i-1]->total; ?></td>
                                </tr>
      ...
      <th class="b1" style="text-align: center;">মালিকের অংশ</th> </tr>
                              ...
                              <tbody style="height: 21px;">
                                ...
                                <?php for($v = 1; $v<=$nexthalf; $v++) {
                                $i++;
                                ?>
                                 
                                <tr>
                                  <td class="b1 input_bangla"><?php echo bn_number($i-1); ?></td>
                                  <td class="b1"><?php echo $mdatas[$i-2]->name; ?></td>
                                  <td class="b1 input_bangla" style="text-align: center;"><?php echo $mdatas[$i-2]->total; ?></td>
                            ...
                            <?php } ?>
                              ...
                              <?php /*<table style="margin-top:5px; width:100%;">
                                <tbody>
                                  <tr>
...
?>
                           ...
                           <?php if (count(json_decode($data['jomi_info'], true)) > 1) { ?>
    <table class="b1" style="border-collapse: collapse; margin:10px 2px ; width: <?php echo $jomi_table_width; ?>; font-size: 11px; float: left;">
<?php } else { ?>
...
<?php } ?>
    ...
    <tbody style="height: 21px;">
        ...
        <?php foreach (array_slice(json_decode($data['jomi_info'], true), 0, $half) as $key => $jomi) { ?>
    ...
    <table class="b1" style="border-collapse: collapse; margin:10px 2px ; width: <?php echo $jomi_table_width; ?>; font-size: 11px; float: left;">
        ...
        <tbody style="height: 21px;">
            ...
            <?php foreach (array_slice(json_decode($data['jomi_info'], true), $half) as $key => $jomi) { ?>
            <?php $total += $jomi['jomi_poriman']; ?>
            <tr>
...
<?php } ?>
  ...
  <tbody>
    <tr>
      <th style="text-align: center;" colspan="8">আদায়ের বিবরণ </th>
    </tr>
    <tr>
      <td style="text-align: center;">তিন বৎসরের ঊর্ধ্বের বকেয়া</td>
      <td style="text-align: center;">গত তিন বৎসরের বকেয়া </td>
      <td style="text-align: center;">বকেয়ার জরিমানা ও ক্ষতিপূরণ </td>
...
<div style="width:100% !important;">
    ...
    <p class="dotted_botton">সর্বমোট (কথায়):
    <?php 
