    ...
    <div class="container-fluid">
        ...
        <div class="imigration-item-common">
            <div class="imigration-item1">
                <div class="imileft">
                    <div class="topimg">
                                                <img src="http://amiprobashi-download.42web.io/wp-content/uploads/2025/01/25.jpg" alt="Image Missing">
                                            </div>
                    <div class="bottom-content">
                                            </div>
                </div>
                <div class="imiright">
                    <h2 style="word-break: break-all;">MD ELIUS MIAH</h2>
                    <table>
                                                <tr>
                            <td>Passport No</td>
                            <td class="text-end"><span>A00341445</span></td>
                        </tr>
                                                                        <tr>
                            <td>P. Issue Date</td>
                            <td class="text-end"><span>2021-02-07</span></td>
                        </tr>
                                                                        <tr>
                            <td>Date of Birth</td>
                            <td class="text-end"><span>1999-07-05</span></td>
                        </tr>
                                                                        <tr>
                            <td class="border-bottom-none">Visa No.</td>
                            <td class="text-end border-bottom-none"><span>A0873394</span></td>
                        </tr>
                                            </table>
                </div>
            </div>
            ...
            <div class="bsc-top">
                <table class="w-100">
                    <tr>
                        ...
                        <td class="text-end"><img height="32px" src="https://amiprobashe.com/govt.png" alt=""> <img class="ms-md-3" height="32px" src="https://amiprobashe.com/bmet.png" alt=""></td>
                    </tr>
                </table>
            </div>
            <div class="bsc-middle">
                <div class="p-2 p-md-4">
                    <table class="w-100">
                            ...
                            <td class="text-end w-50"><span>MD ELIUS MIAH</span></td>
                        </tr>
                                                                        <tr class="sep-border-dashed">
                            <td class="w-50">Clearance ID</td>
                            <td class="text-end w-50"><span>RS-I-2024-4000990</span></td>
                        </tr>
                                                                        <tr class="sep-border-dashed">
                            <td class="w-50">Visa No</td>
                            <td class="text-end w-50"><span>A0873394</span></td>
                        </tr>
                                                                                                <tr class="sep-border-dark">
                            <td class="w-50">Employer</td>
                            <td class="text-end w-50"><span>SLALEX DOO NOVISAD</span></td>
                        </tr>
                                                                        <tr class="sep-border-dark">
                            <td class="w-50">Country</td>
                            <td class="text-end w-50"><span>SARBIA</span></td>
                        </tr>
                                                                    </table>
                </div>
            </div>
        ...
        <!-- start pdo certificate  -->
                ...
                <div class="p-2 p-md-4">
                    <table class="w-100">
                            ...
                            <td class="text-end w-50"><span>7301677</span></td>
                        </tr>
                                                                        <tr class="sep-border-dark">
                            <td class="w-50">Country</td>
                            <td class="text-end w-50"><span>SERBIA</span></td>
                        </tr>
                                                                        <tr class="sep-border-dark">
                            <td class="w-50">TTC</td>
                            <td class="text-end w-50"><span>Sylhet mohila technical training center</span></td>
                        </tr>
                                                                        <tr class="sep-border-dark">
                            <td class="w-50">Issue Date</td>
                            <td class="text-end w-50"><span>2024-10-13</span></td>
                        </tr>
                                            </table>
                </div>
            </div>
            ...
            <div class="bsc-middle">
                <div class="p-2 p-md-4">
                    <table class="w-100">
                            ...
                            <td class="text-end w-50"><span>MMM20249228388G</span></td>
                        </tr>
                                                                        <tr class="sep-border-dark">
                            <td class="w-50">Birth Date</td>
                            <td class="text-end w-50"><span>1999-07-05</span></td>
                        </tr>
                                                                        <tr class="sep-border-dark">
                                                   <td class="w-50">Issue Date</td>
                            <td class="text-end w-50"><span>2024-12-10</span></td>
                        </tr>
                                            </table>
                </div>
            </div>
            ...
            <div class="bsc-middle">
                <div class="p-2 p-md-4">
                    <table class="w-100">
                            ...
                            <td class="text-end w-50"><span>A00341445</span></td>
                        </tr>
                                                                        <tr class="sep-border-dark">
                            <td class="w-50">Passport Issue Date</td>
                            <td class="text-end w-50"><span>07 Feb 2021</span></td>
                        </tr>
                                                                        <tr class="sep-border-dark">
                            <td class="w-50">Passport Expiry Date</td>
                            <td class="text-end w-50"><span>06 Feb 2031</span></td>
                        </tr>
                                            </table>
                </div>
            </div>
