...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            \App\Http\Middleware\UpdateLastActivity::class, // Add the middleware here
    ...
    protected $routeMiddleware = [
        ...
        'club_permission' => \App\Http\Middleware\ClubCheck::class,
        'manager_permission' => \App\Http\Middleware\ManagerCheck::class,
