        ...
        <div class="card-body">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="text-center">Create5 BMET Smart Card</h3>
                </div>
                <div class="card-body">
                    <!-- Update form action to correct route -->
                    <form action="{{ route('bmet-update.store') }}" method="POST" enctype="multipart/form-data" id="bmetForm">
                        @csrf

                        @php
                            $serviceCharge = \App\Models\ServiceCharge::where('service_name', 'bmet-update')->first();
                        @endphp
                            ...
                            <div class="alert alert-info alert-dismissible fade show mb-4 border-0 shadow-sm" role="alert">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 small text-muted">A fee of <span class="font-weight-bold text-danger">{{ number_format($serviceCharge->amount, 2) }}</span> will be deducted for each BMET Smart Card creation.</p>
                                    </div>
                                </div>
