            ...
            <span style="z-index: 10;">
                <div class="mr_header">
                    ...
                    <div class="middle_part">
                        ...
                        <h2><span class="bn">জন্ম নিবন্ধন সনদ /</span> <span class="en">Birth Registration Certificate</span></h2>
                    </div>
                    ...
                    <div class="middle">
                        ...
                        <div style="margin-top: 5px;margin-bottom: 24px !important;" class="td">
                            <div class="left">
                                ...
                                <div class="part2" style="width: 400px;">
                                    ...
                                    <p><span style="margin-left:5px"><?php if(isset($data['dob'])){echo convertDateToEnglish($data['dob']);} ?></span></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div style="margin-top: 30px;" class="new_td">
                            <div class="left">
                                ...
                                <div class="part2">
                                    <p><span class="bn"><?php if(isset($data['permanent_bangla'])){ echo $data['permanent_bangla'];}?></span></p>
                                </div>
                            </div>
                            <div class="right">
                                <div class="part1">
                                ...
                                <div class="part2">
                                    <p><span style="font-weight:500"><?php if(isset($data['permanent_english'])){ echo $data['permanent_english'];}?></span></p>
                                </div>
                            </div>
                        </div>
