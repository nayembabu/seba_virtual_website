...
<head>
    ...
    <title>Return Document - {{ $returnData->tin }}</title>
...
<script>
    ...
    function printDocument(type) {
        document.querySelectorAll(".document-to-print").forEach(el => {
            el.classList.add("hidden-for-print");
        });

        if (type === "ack") {
            const isBnActive = document.getElementById("btn-lang-bn").classList.contains("lang-active");
            const targetId = isBnActive ? "acknowledgement-slip-bn" : "acknowledgement-slip-en";
            document.getElementById(targetId).classList.remove("hidden-for-print");
            document.title = "Return_Ack_{{ $returnData->tin }}";
        } else {
            document.getElementById("tax-certificate").classList.remove("hidden-for-print");
            document.title = "Tax_Certificate_{{ $returnData->tin }}";
        }
