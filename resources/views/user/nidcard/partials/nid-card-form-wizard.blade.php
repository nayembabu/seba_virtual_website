    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="date" name="issue_date" id="issue_date_input" class="form-control bn-input @error('issue_date') is-invalid @enderror" value="{{ $o('issue_date', date('Y-m-d')) }}" required onchange="showBanglaDate(this.value)">
...
<script>
function showBanglaDate(isoVal) {
    var el = document.getElementById("issue_date_bn");
    if (!el) return;
    if (!isoVal) { el.textContent = ""; return; }
    var dateStr = typeof toIso === "function" ? toIso(isoVal) : isoVal;
    if (typeof toBanglaDate === "function") {
        el.textContent = toBanglaDate(dateStr);
    } else if (typeof toBanglaNumerals === "function") {
        el.textContent = toBanglaNumerals(dateStr);
    }
}
document.addEventListener("DOMContentLoaded", function() {
    var inp = document.getElementById("issue_date_input");
    if (inp && inp.value) showBanglaDate(inp.value);
});
</script>
