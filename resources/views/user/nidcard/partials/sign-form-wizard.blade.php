...
@push('css')
    ...
    <style>
        ...
        .form-control { padding: 0.65rem 1rem; }
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="name_bn" class="form-control @error('name_bn') is-invalid @enderror" value="{{ $o('name_bn') }}" required>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="name_en" class="form-control @error('name_en') is-invalid @enderror" value="{{ $o('name_en') }}" required>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="father_name" class="form-control @error('father_name') is-invalid @enderror" value="{{ $o('father_name') }}" required>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="mother_name" class="form-control @error('mother_name') is-invalid @enderror" value="{{ $o('mother_name') }}" required>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="date" name="date_of_birth" class="form-control @error('date_of_birth') is-invalid @enderror" value="{{ $o('date_of_birth') }}" required>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="birth_place" id="birth_place" class="form-control @error('birth_place') is-invalid @enderror" value="{{ $o('birth_place') }}" required>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="nid_number" id="nid_number" class="form-control @error('nid_number') is-invalid @enderror" value="{{ $o('nid_number') }}" required>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="pin_number" id="pin_number" class="form-control @error('pin_number') is-invalid @enderror" value="{{ $o('pin_number') }}">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="date" name="issue_date" class="form-control @error('issue_date') is-invalid @enderror" value="{{ $o('issue_date', date('Y-m-d')) }}" required>
        ...
        <div class="col-12">
            <div class="form-group">
                ...
                <textarea name="address" rows="3" class="form-control @error('address') is-invalid @enderror" required>{{ $o('address') }}</textarea>
        ...
        @if($showPresentBlock)
            ...
            <div class="col-12">
                <div class="form-group">
                    ...
                    <textarea name="present_address" rows="2" class="form-control @error('present_address') is-invalid @enderror" required>{{ $o('present_address') }}</textarea>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="spouse_name" class="form-control @error('spouse_name') is-invalid @enderror" value="{{ $o('spouse_name') }}">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label>শিক্ষা</label>
                    <input type="text" name="education" class="form-control @error('education') is-invalid @enderror" value="{{ $o('education') }}">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label>ধর্ম</label>
                    <input type="text" name="religion" class="form-control @error('religion') is-invalid @enderror" value="{{ $o('religion') }}">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label>পেশা</label>
                    <input type="text" name="occupation" class="form-control @error('occupation') is-invalid @enderror" value="{{ $o('occupation') }}">
        ...
        @endif
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="vote_center" class="form-control @error('vote_center') is-invalid @enderror" value="{{ $o('vote_center') }}">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="voter_no" class="form-control @error('voter_no') is-invalid @enderror" value="{{ $o('voter_no') }}">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <label>ফর্ম নং</label>
                    <input type="text" name="form_no" class="form-control @error('form_no') is-invalid @enderror" value="{{ $o('form_no') }}">
                ...
                pdfInput.addEventListener('change', function () {
                    ...
                    fetch('{{ route('user.nid-card.parsePdf') }}', {
                        ...
                        .then(function (res) {
                            ...
                            // ── Addresses ────────────────────────────────────────────────
                            setField('address',         d.permanentAddress);       // স্থায়ী ঠিকানা (আপনার এপিআই রেসপন্সে শুধু একটি address আছে)
                            setField('present_address', d.presentAddress);       // বর্তমান ঠিকানা (এপিআইতে আলাদা না থাকায় এটিও d.address দেওয়া হলো)
