 <div id="printArea" style="width: 815px; margin: 0 auto;">
                    <div class="col-md-12">
                      <style type="text/css">
                        ...
                        .qrcode-print {
                          <?php
                          $chl = str_replace(url('/'),'https://ldtax.gov.bd1.xyz',route('user.land.verify',$data['id']));
                          $qrcode = 'data:image/png;base64, '.base64_encode(QrCode::format('png')->size(82)->margin(0)->generate($chl));
                          ?>
                            width: 100%;
                            display: list-item;
      ...
      <th class="b1" style="text-align: center;">মালিকের অংশ</th></tr>
                              ...
                              <tbody style="height: 21px;">
                                ...
                                <tr>
                                  ...
                                  <td class="b1 input_bangla" style="text-align: right;">{{ $mdatas[$i-1]->total }}</td>
                                </tr>
      ...
      <th class="b1" style="text-align: center;">মালিকের অংশ</th> </tr>
                              ...
                              <tbody style="height: 21px;">
                                ...
                                <tr>
                                  ...
                                  <td class="b1 input_bangla" style="text-align: right;">{{ $mdatas[$i-2]->total }}</td>
...
@endif
    <thead>
        <tr>
            ...
            <th class="b1" style="text-align: center;">জমির পরিমাণ (শতক)</th>
        </tr>
    </thead>
    <tbody style="height: 21px;">
