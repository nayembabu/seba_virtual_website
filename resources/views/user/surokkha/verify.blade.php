...
<head>
  ...
  <link rel="stylesheet" href="{{url('assets/surokkha')}}/main.css" />
</head>
  ...
  <div id="root">
    <header class="su-h-header">
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
          <a class="navbar-brand main-logo" href="#"><img width="" class="img-fluid" src="{{url('assets/surokkha')}}/img/logo-f.5c608b98.png" alt="Surokkha" /></a><button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav3" aria-controls="navbarNav3" aria-expanded="false" aria-label="Toggle navigation">
            ...
            <div class="row text-center">
              ...
              <div class="col-12 col-sm-6 col-lg-5 col-xl-4 m-auto pt-4 pt-sm-0">
                <div class="su-inner-banner-img">
                  <img alt="image" class="img-fluid" src="{{url('assets/surokkha')}}/img/new-certification-card.ac1c4d8c.png" />
                </div>
              </div>
            </div>
          </div>
                  ...
                  <div class="col-md-12 p-sm-0">
                    ...
                    <div style="border: 1px solid rgb(222, 226, 230)">
                      <div class="text-center pt-2 show-mobile no-print">
                        <img src="{{url('assets/surokkha')}}/img/gov_logo.0b7f8514.png" width="70" />&nbsp; &nbsp; &nbsp; &nbsp;<img src="{{url('assets/surokkha')}}/img/mujib100.75b35add.png" width="100" />
                      </div>
                      <div class="row m-0 mt-2">
                        <div class="col-md-3 col-sm-12 text-right hide-mobile">
                          <img src="{{url('assets/surokkha')}}/img/gov_logo.0b7f8514.png" width="70" />
                        </div>
                        ...
                        <div class="col-md-3 col-sm-12 text-left hide-mobile">
                          <img src="{{url('assets/surokkha')}}/img/mujib100.75b35add.png" width="100" />
                        </div>
                      </div>
                      ...
                      <div class="row m-0">
                        <div class="col-md-5 p-0">
                          ...
                          <div class="row m-0">
                            ...
                            <div class="col-6" style="border: 1px dashed rgb(222, 226, 230)">
                              <div class="cert-verify-content-div" style="font-size: 13px;text-align: left;padding: 5px;overflow-wrap: break-word;">
                                <?php echo $data['national_id']; ?> <br> </div>
                            </div>
                          </div>
                          <div class="row m-0">
                            <div class="col-6" style="border: 1px dashed rgb(222, 226, 230)">
                          ...
                          <div class="row m-0">
                            ...
                            <div class="col-6" style="border: 1px dashed rgb(222, 226, 230)">
                              <div class="cert-verify-content-div" style="font-size: 13px;text-align: left;padding: 5px;overflow-wrap: break-word;">
                                <?php echo date("d-m-Y", strtotime($data['date_birth'])); ?> </div>
                            </div>
                          </div>
                          <div class="row m-0">
                            <div class="col-6" style="border: 1px dashed rgb(222, 226, 230)">
                        ...
                        <div class="col-md-7 p-0">
                          ...
                          <div class="row m-0">
                            ...
                            <div class="col-6" style="border: 1px dashed rgb(222, 226, 230)">
                              <div class="cert-verify-content-div" style="font-size: 13px;text-align: left;padding: 5px;overflow-wrap: break-word;">
                                <?php echo date("d-m-Y", strtotime($data['doseone_date'])); ?> </div>
                            </div>
                          </div>
                          <div class="row m-0">
                            <div class="col-6" style="border: 1px dashed rgb(222, 226, 230)">
        ...
        if ($type1 == '1') {
            ...
            echo $data['doseone_name'];
                          ...
                          <div class="row m-0">
                            ...
                            <div class="col-6" style="border: 1px dashed rgb(222, 226, 230)">
                              <div class="cert-verify-content-div" style="font-size: 13px;text-align: left;padding: 5px;overflow-wrap: break-word;">
                                <?php echo date("d-m-Y", strtotime($data['dosetwo_date'])); ?> </div>
                            </div>
                          </div>
                          <div class="row m-0">
                            <div class="col-6" style="border: 1px dashed rgb(222, 226, 230)">
                            ...
                            <div class="col-6" style="border: 1px dashed rgb(222, 226, 230)">
                              <div class="cert-verify-content-div" style="font-size: 13px;text-align: left;padding: 5px;overflow-wrap: break-word;">
                                <?php echo $data['dosetwo_name']; ?> </div>
                            </div>
                          </div>
                          <div class="row m-0">
                            <div class="col-6" style="border: 1px dashed rgb(222, 226, 230)">
                   ...
                   <?php $type= $data['dosethree_name']; 
                      ...
                      <div class="col-4" style="border: 1px dashed rgb(222, 226, 230);"><div class="cert-verify-content-div" style="font-size: 13px; text-align: left; padding: 5px; overflow-wrap: break-word;">  <?php echo date("d-m-Y", strtotime($data['dosethree_date'])); ?> </div>
                          </div>
                      </div>
                    ...
                    <div class="text-center p-2 mb-3 footer-cert-verify-img" style="border: 1px solid rgb(222, 226, 230)">
                      <img src="{{url('assets/surokkha')}}/img/Credit_Logo.68be46aa.png" alt="ict logo" style="max-width: 80%" />
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="container mt-5">
        <div class="row text-left">
          <div class="col-12 col-md-2 su-footer-logo mb-3">
            <img src="{{url('assets/surokkha')}}/img/logo_white.8ef9a1c4.svg" alt="Surokkha" />
          </div>
          ...
          <div class="col-12 col-md-4 su-footer-l-col">
            ...
            <img alt="" class="img-fluid" src="{{url('assets/surokkha')}}/img/ict.52410752.png" />
          </div>
          <div class="col-12 col-md-4 pt-5 pt-md-0 su-footer-r-col">
            <p>সহযোগী সংস্থাসমূহ -&nbsp;</p>
            <img alt="" class="img-fluid" src="{{url('assets/surokkha')}}/img/org.ed08c793.png" />
          </div>
        </div>
      </div>
    </footer>
