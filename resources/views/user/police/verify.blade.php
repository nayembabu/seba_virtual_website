                            ...
                            <div class="col col-12 apex-col-auto">
                                <div id="printID" class="">
                                    ...
                                    <div class="main">
                                       ...
                                       <img style="float: left; margin-top: 5px" src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(80)->generate(str_replace(url('/'), 'https://pcc.police.gov.bdi.ink', route('user.police.verify', $data['police_reg'])))) !!}" alt="" title="PCC" width="80" height="80" />
