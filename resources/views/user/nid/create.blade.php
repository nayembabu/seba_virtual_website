...
@php
    $serviceCharge = \App\Models\ServiceCharge::where('service_name', 'nid')->first();
@endphp
...
<div class="card card-custom m-0 m-md-4 my-4 m-md-0 shadow">
    <div class="card-body">
            ...
            <div class="col-md-12">
                <div class="d-flex justify-content-between align-items-center">
                    <h3 class="card-title text-primary mb-0">
                        <i class="fas fa-graduation-cap fa-fw"></i>এনআইডি - তৈরি
                    </h3>
        ...
        @endif
            ...
            @endif
                     <form action="{{ route('user.nid.store') }}" method="POST" enctype="multipart/form-data" id="signForm" class="needs-validation" novalidate>
                        @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control @error('pin_number') is-invalid @enderror" id="pin_number" name="pin_number" value="{{ old('pin_number') }}">
                                @error('pin_number')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
