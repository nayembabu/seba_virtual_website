    ...
    <table width="800" cellpadding="2" cellspacing="2">
        <tr>
            ...
            <td align="right" style="line-height:22px;font-size:17px;">
                ...
                <?php 
                $verifyUrl = route('visa-applications.verify', $visaApplication->visa_number);
                $qrCodeUrl = "https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=" . urlencode($verifyUrl);
                ?>
                <img src="{{ $qrCodeUrl }}" width="90" style="margin-top: 10px; background: white;" title="Scan to verify this visa">
            </td>
        </tr>
        <tr>
        	<td colspan="2">
