...
<head>
    ...
    @font-face {
            ...
            src: url('path/to/SolaimanLipi.ttf');
        }

        /* Apply SolaimanLipi font to all text elements */
        body, p, h1, h2, span {
...
<body>
    <button class="print-button" onclick="window.print()">Print</button> <!-- Print button outside the wrapper -->
    <div class="wrapper">
        <div class="content">
<body>
    <div class="background">
        
    <!-- Removed the src attribute from the img tag -->
    <img class="crane" height="1000px" width="750px">
...
<div style="position: absolute; left: 50%; top: 11%; transform: translateX(-50%); width: auto;">
        <img src="https://surokkha.gov.bd/favicon.png" alt="" style="width: 60px; height: 60px;">
    </div>
...
<div style="position: absolute; left: 6.4%; top: 18.6%;width: auto;font-size: 10px; color: black;" id="issue_time">ইস্যুর সময়:</div>
	...
	<div style="position: absolute; left: 39%; top: 20.5%; width: auto; font-size: 14px; font-weight: bold; color: black;">
    ট্রেড লাইসেন্স নং:
</div>

<div id="trade_no" style="position: absolute; left: 53%; top: 20.5%; width: auto; font-size: 14px; font-weight: bold; color: Red;">
    <?php echo $data['trade_no']; ?>
</div>
...
<script>
    ...
    function generateQRCode(tradeNo) { 
        ...
        var verificationLink = 'https://verify.grameenseba.net/user/trade/verify/' + tradeNo;
	...
	<!-- Current Address Box -->
<div style="position: absolute; left: 6.4%; top: 55.7%; width: auto; font-size: 10px; color: rgb(7, 7, 7); border: 1px solid black; padding: 10px; width: 45%; box-sizing: border-box;">
    <div class="bangla-text">১২। মালিক/স্বত্বাধীকারীর বর্তমান ঠিকানা:</div>
    <div id="address" style="font-weight: bold; font-size: 10px; color: rgb(7, 7, 7);">
        <?php echo $data['address']; ?>
    </div>
</div>

<!-- Permanent Address Box -->
<div style="position: absolute; left: 50%; top: 55.7%; width: auto; font-size: 10px; color: rgb(7, 7, 7); border: 1px solid black; padding: 10px; width: 45%; box-sizing: border-box;">
    <div class="bangla-text">মালিক/স্বত্বাধীকারীর স্থায়ী ঠিকানা:</div>
    <div id="address" style="font-weight: bold; font-size: 10px; color: rgb(7, 7, 7);">
        <?php echo $data['address']; ?>
    </div>
</div>

<div style="position: absolute; left: 6.4%; top: 65%; width: auto; font-size: 10px; color: rgb(7, 7, 7);" class="bangla-text">
    ১৩। আদর্শ কর তফসিল, ২০১৩ এর ক্রমিক নং: ৩৩৭
</div>

<div style="display: flex; justify-content: space-between; position: absolute; left: 6.4%; top: 70%; width: 80%;">

     <table style="border-collapse: collapse; width: 45%; font-size: 8px; color: rgb(7, 7, 7);">
        <tr>
            <td style="border: 1px solid black; padding: 4px;">১৪। ট্রেড লাইসেন্স ফি (নতুন):</td>
            <td style="border: 1px solid black; padding: 4px;"><?php echo $data['fee']; ?> টাকা।</td>
        </tr>
        <tr>
            <td style="border: 1px solid black; padding: 4px;">পারমিট ফি:</td>
            <td style="border: 1px solid black; padding: 4px;"><?php echo $data['permit_amount']; ?> টাকা।</td>
        </tr>
        <tr>
            <td style="border: 1px solid black; padding: 4px;">সার্ভিস চার্জ:</td>
            <td style="border: 1px solid black; padding: 4px;"><?php echo $data['charge_amount']; ?> টাকা।</td>
        </tr>
        <tr>
 <div class="double-border"></div>            <td style="border: 1px solid black; padding: 4px;">বকেয়া:</td>
            <td style="border: 1px solid black; padding: 4px;"><?php echo $data['due_amount']; ?> টাকা।</td>
        </tr>
        <tr>
            <td style="border: 1px solid black; padding: 4px;">সারচার্জ:</td>
            <td style="border: 1px solid black; padding: 4px;"><?php echo $data['others_amount']; ?> টাকা।</td>
        </tr>
    </table>

    <table style="border-collapse: collapse; width: 45%; font-size: 8px; color: rgb(7, 7, 7);">
        <tr>
            <td style="border: 1px solid black; padding: 4px;">পেশা ব্যবসা ও বৃত্তির উপর কর:</td>
            <td style="border: 1px solid black; padding: 4px;"><?php echo $data['income_amount']; ?> টাকা।</td>
        </tr>
        <tr>
            <td style="border: 1px solid black; padding: 4px;">সাইনবোর্ড (পরিচিতিমূলক):</td>
            <td style="border: 1px solid black; padding: 4px;"><?php echo $data['sine_amount']; ?> টাকা।</td>
        </tr>
        <tr>
            <td style="border: 1px solid black; padding: 4px;">আয়কর/উৎস কর:</td>
            <td style="border: 1px solid black; padding: 4px;"><?php echo $data['tax_amount']; ?> টাকা।</td>
        </tr>
        <tr>
            <td style="border: 1px solid black; padding: 4px;">ভ্যাট:</td>
            <td style="border: 1px solid black; padding: 4px;"><?php echo $data['vat_amount']; ?> টাকা।</td>
        </tr>
        <tr>
            <td style="border: 1px solid black; padding: 4px;">সংশোধন ফি:</td>
            <td style="border: 1px solid black; padding: 4px;"><?php echo $data['cr_amount']; ?> টাকা।</td>
        </tr>
    </table>
