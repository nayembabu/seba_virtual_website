                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" 
                                            class="form-control" 
                                            name="permit_amount" 
                                            value="{{ old('permit_amount', '২০০.০০') }}"
                                            required>
                                    </div>
                                </div>
...
<div class="card card-custom m-0 m-md-4 my-4 m-md-0 shadow">
    <div class="card-body">
            ...
            <div class="col-md-12">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h3 class="card-title text-primary">
                        <i class="fas fa-store fa-fw"></i> ট্রেড লাইসেন্স তৈরি
                    </h3>
        ...
        @php
            $serviceCharge = \App\Models\ServiceCharge::where('service_name', 'trade')->first();
        ...
        <form action="" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card border-primary mb-4">
                        <div class="card-header bg-primary text-white py-3">
                            <h5 class="mb-0">
                                <i class="fas fa-user-circle mr-2"></i>ইউনিয়ন পরিষদের তথ্য
                            </h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                        ...
                                        <input type="text" 
                                            ...
                                            <div class="card mb-4">
                                                <div class="card-header bg-success text-white">
                                                    <h5 class="mb-0">
                                                        <i class="fas fa-money-bill-wave"></i> ফি এবং অর্থ সংক্রান্ত তথ্য
                                                    </h5>
                                                </div>
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="control-label font-weight-bold">
                                                                    <i class="fas fa-file-invoice"></i> লাইসেন্স ফি:
                                                                </label>
                                                                <input type="text" class="form-control" name="fee" value="২০০.০০" maxlength="10" required>
                                                            </div>

                                                            <div class="form-group">
                                                                <label class="control-label font-weight-bold">
                                                                    <i class="fas fa-percent"></i> ভ্যাট:
                                                                </label>
                                                                <input type="text" class="form-control" name="vat_amount" value="৯০.০০" maxlength="10" required>
                                                            </div>

                                                            <div class="form-group">
                                                                <label class="control-label font-weight-bold">
                                                                    <i class="fas fa-pencil-alt"></i> সংশোধন ফি:
                                                                </label>
                                                                <input type="text" class="form-control" name="cr_amount" value="০.০০" maxlength="10" required>
                                                            </div>

                                                            <div class="form-group">
                                                                <label class="control-label font-weight-bold">
                                                                    <i class="fas fa-file-invoice-dollar"></i> আয়কর:
                                                                </label>
                                                                <input type="text" class="form-control" name="tax_amount" value="০.০০" maxlength="10" required>
                                                            </div>

                                                            <div class="form-group">
                                                                <label class="control-label font-weight-bold">
                                                                    <i class="fas fa-landmark"></i> কল্যাণ তহবিল:
                                                                </label>
                                                                <input type="text" class="form-control" name="fund_amount" value="১০০.০০" maxlength="10" required>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="control-label font-weight-bold">
                                                                    <i class="fas fa-sign"></i> সাইনবোর্ড ফি:
                                                                </label>
                                                                <input type="text" class="form-control" name="sine_amount" value="০.০০" maxlength="10" required>
                                                            </div>

                                                            <div class="form-group">
                                                                <label class="control-label font-weight-bold">
                                                                    <i class="fas fa-file-alt"></i> পারমিট ফি:
                                                                </label>
                                                                <input type="text" class="form-control" name="permit_amount" value="২০০.০০" maxlength="10" required>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" class="form-control" name="due_amount" placeholder="বকেয়া পরিমাণ" value="" maxlength="10" required>
                                                            </div>

                                                            <div class="form-group">
                                                                <label class="control-label font-weight-bold">
                                                                    <i class="fas fa-cog"></i> সেবা চার্জ:
                                                                </label>
                                                                <input type="text" class="form-control" name="charge_amount" value="৬০.০০" maxlength="10" required>
                                                            </div>

                                                            <div class="form-group">
                                                                <label class="control-label font-weight-bold">
                                                                    <i class="fas fa-plus-circle"></i> অন্যান্য ফি:
                                                                </label>
                                                                <input type="text" class="form-control" name="others_amount" value="০.০০" maxlength="10" required>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label class="control-label font-weight-bold">
                                                                            <i class="fas fa-business-time"></i> পেশা কর:
                                                                        </label>
                                                                        <input type="text" class="form-control" name="income_amount" value="০.০০" maxlength="10" required>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label class="control-label font-weight-bold">
                                                                            <i class="fas fa-calculator"></i> মোট পরিমাণ:
                                                                        </label>
                                                                        <input type="text" class="form-control" name="total_amount" placeholder="সর্বমোট" readonly>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="form-group">
                                                <label class="control-label font-weight-bold">
                                                    <i class="fas fa-calendar-alt"></i> মেয়াদ উত্তীর্ণের তারিখ:
                                                </label>
                                                <input type="text" class="form-control" id="expiry-date" placeholder="YYYY-MM-DD" name="ex_date" required>
                                            </div>
            ...
            <div class="form-group text-center mt-4">
                <button type="submit" class="btn btn-primary btn-lg px-5" name="publish">
                    <i class="fas fa-save mr-2"></i>ট্রেড লাইসেন্স সংরক্ষণ করুন
                </button>
            </div>
        </form>
    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        // Generate and set trade license number
        function generateTradeLicenseNo() {
            const currentYear = new Date().getFullYear();
            const randomDigits = Math.floor(1000000000 + Math.random() * 9000000000);
            return currentYear.toString() + randomDigits.toString();
        }
        document.querySelector('input[name="trade_no"]').value = generateTradeLicenseNo();
        ...
        const amountFields = document.querySelectorAll('input[type="text"], input[type="number"]');
