        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h2>Create New E-Visa</h2>
                </div>

                <div class="card-body">
                    <form action="{{ route('user.evisas.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf

                        @php
                            $serviceCharge = \App\Models\ServiceCharge::where('service_name', 'evisas')->first();
                        @endphp
                            ...
                            <div class="alert alert-info alert-dismissible fade show mb-4 border-0 shadow-sm" role="alert">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 small text-muted">A fee of <span class="font-weight-bold text-danger">{{ number_format($serviceCharge->amount, 2) }}</span> will be deducted for each E-Visa creation.</p>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('visa_id') is-invalid @enderror" 
                                    id="visa_id" name="visa_id" value="{{ old('visa_id') }}" required>
                                @error('visa_id')
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('evisa_number') is-invalid @enderror" 
                                    id="evisa_number" name="evisa_number" value="{{ old('evisa_number') }}" required>
                                @error('evisa_number')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('ref_number') is-invalid @enderror" 
                                    id="ref_number" name="ref_number" value="{{ old('ref_number') }}" required>
                                @error('ref_number')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('place_of_issue') is-invalid @enderror" 
                                    id="place_of_issue" name="place_of_issue" value="{{ old('place_of_issue') }}" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" step="0.01" class="form-control @error('visa_fee') is-invalid @enderror" 
                                    id="visa_fee" name="visa_fee" value="{{ old('visa_fee') }}" required>
                                @error('visa_fee')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control @error('travel_document') is-invalid @enderror" 
                                    id="travel_document" name="travel_document" value="{{ old('travel_document') }}" required>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control @error('travel_doc_no') is-invalid @enderror" 
                                    id="travel_doc_no" name="travel_doc_no" value="{{ old('travel_doc_no') }}" required>
                                @error('travel_doc_no')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="date" class="form-control @error('travel_doc_issue') is-invalid @enderror" 
                                    id="travel_doc_issue" name="travel_doc_issue" value="{{ old('travel_doc_issue') }}" required>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="date" class="form-control @error('travel_doc_expiry') is-invalid @enderror" 
                                    id="travel_doc_expiry" name="travel_doc_expiry" value="{{ old('travel_doc_expiry') }}" required>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-primary">Create E-Visa</button>
