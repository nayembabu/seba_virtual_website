...
<div class="card card-custom m-0 m-md-4 my-4 m-md-0 shadow">
    <div class="card-body">
        ...
        <form action="{{ route('user.ssc_certificate.update', $ssc_certificate->id) }}" method="POST" id="sscForm" class="needs-validation" novalidate>
            @csrf
            @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           name="student_name" 
                                           value="{{ old('student_name', $ssc_certificate->student_name) }}" 
                                           required>
                                    @error('student_name')
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date" 
                                           ...
                                           name="dob" 
                                           value="{{ old('dob', $ssc_certificate->dob ? date('Y-m-d', strtotime($ssc_certificate->dob)) : '') }}" 
                                           min="1900-01-01"
                                           max="{{ date('Y-m-d') }}"
                                           required>
                                    @error('dob')
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           name="father_name" 
                                           value="{{ old('father_name', $ssc_certificate->father_name) }}" 
                                           required>
                                    @error('father_name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           name="mother_name" 
                                           value="{{ old('mother_name', $ssc_certificate->mother_name) }}" 
                                           required>
                                    @error('mother_name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <input type="hidden" name="dob_day_month_words" id="dob_day_month_words" value="{{ old('dob_day_month_words', $ssc_certificate->dob_day_month_words) }}">
                                <input type="hidden" name="dob_year_words" id="dob_year_words" value="{{ old('dob_year_words', $ssc_certificate->dob_year_words) }}">
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           name="school_name" 
                                           value="{{ old('school_name', $ssc_certificate->school_name) }}" 
                                           required>
                                    @error('school_name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control @error('school_address') is-invalid @enderror" 
                                              name="school_address" 
                                              rows="3" 
                                              required>{{ old('school_address', $ssc_certificate->school_address) }}</textarea>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           name="roll_no" 
                                           value="{{ old('roll_no', $ssc_certificate->roll_no) }}" 
                                           required>
                                    @error('roll_no')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-control select2 @error('student_group') is-invalid @enderror" 
                                        ...
                                        <option value="Science" {{ old('student_group', $ssc_certificate->student_group) == 'Science' ? 'selected' : '' }}>বিজ্ঞান</option>
                                        <option value="Commerce" {{ old('student_group', $ssc_certificate->student_group) == 'Commerce' ? 'selected' : '' }}>বাণিজ্য</option>
                                        <option value="Arts" {{ old('student_group', $ssc_certificate->student_group) == 'Arts' ? 'selected' : '' }}>মানবিক</option>
                                    </select>
                                    @error('student_group')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" 
                                           ...
                                           min="0" 
                                           max="5"
                                           value="{{ old('gpa', $ssc_certificate->gpa) }}" 
                                           required>
                                    @error('gpa')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" 
                                           ...
                                           min="1900" 
                                           max="{{ date('Y') }}"
                                           value="{{ old('publication_date', $ssc_certificate->publication_date) }}" 
                                           required>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="number" 
                                           ...
                                           min="1900" 
                                           max="{{ date('Y') }}"
                                           value="{{ old('publication_year', $ssc_certificate->publication_year) }}" 
                                           required>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           name="serial_no_dbs" 
                                           value="{{ old('serial_no_dbs', $ssc_certificate->serial_no_dbs) }}" 
                                           required>
                                    @error('serial_no_dbs')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('registration_no', $ssc_certificate->registration_no) }}" 
                                           required>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" 
                                           ...
                                           value="{{ old('registration_year', $ssc_certificate->registration_year) }}"
                                           min="1900"
                                           max="{{ date('Y') }}" 
                                           required>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           name="dbcsc_no" 
                                           value="{{ old('dbcsc_no', $ssc_certificate->dbcsc_no) }}" 
                                           required>
                                    @error('dbcsc_no')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
...
$(document).ready(function() {
    ...
    flatpickr('input[name="dob"]', {
        ...
        allowInput: true,
        maxDate: 'today',
        defaultDate: $('input[name="dob"]').val() || null,
        onChange: function(selectedDates, dateStr, instance) {
            // Trigger date to words conversion
    ...
    // Initialize date words on page load
    const dobValue = $('input[name="dob"]').val();
    if (dobValue) {
        const dateWords = convertDateToWords(dobValue);
        if (dateWords) {
            $('#dob_day_month_words').val(dateWords.dayMonth);
            $('#dob_year_words').val(dateWords.year);
        }
