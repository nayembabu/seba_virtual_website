...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Copyable SIM number badge — orange tint for SIM conversion */
        .sim-badge {
            font-family: monospace; font-size: 13px;
            background: #fff8f0; color: #7a3e00;
            padding: 3px 8px; border-radius: 5px;
            border: 1px solid #f5c99a; white-space: nowrap;
            cursor: pointer; user-select: all;
            display: inline-block; transition: background 0.2s;
        }
        .sim-badge:hover { background: #fce8cc; }
        .sim-badge .copy-icon { margin-left: 5px; font-size: 11px; color: #c96a00; }

        /* Operator label above badge */
        .operator-label {
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="top-navbar">
            <h4 class="mb-0">SIM Conversion Orders Management</h4>
        ...
        <div class="page-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2><i class="fas fa-sim-card text-primary"></i> সিম কনভার্সন অর্ডার ম্যানেজমেন্ট</h2>
                    <p class="text-muted mb-0">সকল সিম কনভার্সন অর্ডারের তালিকা এবং পরিচালনা</p>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-header bg-white">
                <h5 class="mb-0">SIM Conversion Orders List</h5>
            </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex flex-column gap-2">
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="reason2">ভুল নম্বর প্রদান করা হয়েছে</label>
                        </div>
                        <div class="form-check">
    ...
    <!-- Hidden global PDF input (original approach retained) -->
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            /* Global hidden PDF input handler */
            document.getElementById('hiddenPDFInput').addEventListener('change', function () {
        ...
        function loadOrders(page = 1) {
            ...
            fetch(`/admin/sim-conversions/get-orders?${params}`, {
        ...
        function renderOrders(orders) {
            ...
            tbody.innerHTML = orders.map((order, index) => {
                ...
                /* ── SIM number from form_data ── */
                const simNumber  = getPhoneNumber(order.form_data);
                const operatorLabel = getFormTypeName(order.type);
                const simHtml = simNumber && simNumber !== 'N/A'
                    ? `<small class="operator-label">${escHtml(operatorLabel)}</small>
                       <span class="sim-badge" onclick="copyNumber('${escHtml(simNumber)}')" title="Click to copy">
                           ${escHtml(simNumber)}<i class="fas fa-copy copy-icon"></i>
                       </span>`
        ...
        /* ── PDF upload (global hidden input) ── */
        ...
        function uploadPDFFile(orderId, file) {
            ...
            .then(d => {
                if (d.success) {
                    loadOrders(currentPage); // reload; auto-status handled server-side or separately
                } else {
                    alert('Error: ' + d.message);
                }
            })
            .catch(err => alert('PDF আপলোডে ত্রুটি: ' + err.message));
        }
        ...
        function getFormTypeName(type) {
            return { 1: 'জিপি', 2: 'বাংলালিংক', 3: 'রবি' }[type] || 'Unknown';
        }
