...
@section('content')
    ...
    <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
     ...
     @endif
      ...
      <input id="email-input" type="text" name="email" value="{{ $user->email }}" class="form-control" required />
        <span style="color:red" id="e-error"></span>
        </div>
        
         <div class="form-group">
        <label>
        Password ( Min : 6 Characters ) <small>Leave blank for no changes</small>
        <span class="req">*</span>
        </label>
       <input type="password" name="password" minlength="6" value="" class="form-control" />
        ...
        <input value="{{ $user->phone }}" type="text" id="phone-input" name="phone" class="form-control" required />
