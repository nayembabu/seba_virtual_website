...
<div id="name_en2" style="position: absolute;font-weight: bold;left: 15.5%;top: 39.6%;height: 32px;width: 130px;font-size: 13px;color: rgb(7, 7, 7);margin: auto;align-items: center;" align="center">{{ $data->name_en }}</div>
	...
	<div style="position: absolute; left: 37%; top: 37.5%; width: auto; font-size: 14px; color: rgb(7, 7, 7);">পিতার এন.আই.ডি</div>
	<div id="spouse" style="position: absolute; left: 55%; top: 37.5%; width: auto; font-size: 14px; color: rgb(7, 7, 7);">{{ @$data->nidFather }}</div>
	<div style="position: absolute; left: 37%; top: 40.2%; width: auto; font-size: 14px; color: rgb(7, 7, 7);">মাতার এন.আই.ডি</div>
	<div id="nidMother" style="position: absolute; left: 55%; top: 40.2%; width: auto; font-size: 14px; color: rgb(7, 7, 7);">{{ $data->nidMother }}</div>
	...
	<div id="mobile_no" style="position: absolute; left: 55%; top: 64.8%; width: auto; font-size: 14px; color: rgb(7, 7, 7);">{{ @$data->mobile }}</div>
    ...
    $qr = "https://grameenseba.net/nid/{$data->nid_no}";  // Changed to $data to match rest of template
